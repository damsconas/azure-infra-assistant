            ...
            <div className="flex-shrink-0">
              <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                ...
                {message.role === 'user' ? (
                  ...
                  <svg className="w-5 h-5 text-white" viewBox="0 0 41 41" fill="none">
                  ...
                  {message.files && message.files.length > 0 && (
                    <div className="flex flex-wrap gap-2 mb-3">
                      {message.files.map((file) => (
                        <div
                          key={file.id}
                          className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white border border-gray-200 hover:border-gray-300 transition-colors duration-200"
                        >
                          <i className={`${getFileIcon(file.type)} text-lg ${getFileColor(file.type)}`}></i>
                          <div className="flex flex-col">
                            <span className="text-gray-900 text-sm font-medium max-w-[200px] truncate">
                              {file.name}
                            </span>
